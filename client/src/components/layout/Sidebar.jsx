...
export default function Sidebar({ activeId, onSelect }) {
  ...
  return (
    <>
      {/* ── Desktop sidebar (Dark Slate Leather with Vivid Pirate Ship & Sea Background) ─────────────── */}
      <aside
      ...
      >
        {/* ── Vivid Pirate Ship & Sea Nautical Art Background Layer (High Opacity) ── */}
        <div
        ...
        {/* Darkening Gradient Overlay for crisp text contrast */}
        <div className="absolute inset-0 z-0 bg-gradient-to-b from-[#141820]/75 via-[#0e121a]/65 to-[#0b0e14]/85 pointer-events-none" />
            ...
            return (
              <motion.button
                ...
                className={[
                  ...
                  "w-full text-left transition-all duration-200 group outline-none font-cinzel border backdrop-blur-xs shadow-md",
                  isActive
                    ? "bg-gradient-to-r from-[#2a3242]/95 to-[#1c222e]/95 border-[#c49339] text-amber-300 shadow-xl"
                    : "bg-[#141820]/80 border-[#262c38] text-stone-200 hover:border-[#8c643b] hover:bg-[#1f2633]/95",
                ].join(" ")}
              >
                ...
                {Icon && (
                  <span className={["shrink-0 transition-colors p-1 rounded bg-[#0d1017] border border-[#2b3342]",
                    isActive ? "text-amber-400 border-amber-500/50" : "text-stone-300 group-hover:text-amber-300"
                  ].join(" ")}>
        ...
        <div className="p-3 pb-5 relative z-10" style={{ borderTop: "2px solid #262c38" }}>
          <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg border bg-[#141820]/90 border-[#2b3342] backdrop-blur-xs shadow-lg">
            <div
